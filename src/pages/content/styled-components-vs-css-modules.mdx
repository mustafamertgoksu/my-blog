...
### In React, we can use to create reusable CSS classes. However, we can also use Styled Components are written in JavaScript, while Css Modules are written in CSS. In this article, We will answer the question: Which one should I use?
...
<li>
 ## Maintaniable Code
 ### Css Modules are easier to maintain and understand
</li>

<li>
## Performance
### Css Modules is is performant and faster than Styled Components
</li>
...
<li>
## No nesting
### Css Modules are not allowed to use nesting you have to use scss or less for nesting
</li>
</ul>
